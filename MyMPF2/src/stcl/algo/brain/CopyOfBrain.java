...
public class CopyOfBrain {
	
	protected ArrayList<NeoCorticalUnit> unitlist;
	private SimpleMatrix uniformDistribution;
	
	public CopyOfBrain(int numUnits, Random rand, int ffInputLength, int spatialMapSize, int temporalMapSize, int markovOrder) {
		this(numUnits, rand, ffInputLength, spatialMapSize, temporalMapSize, markovOrder, false);
	}
	
	public CopyOfBrain(int numUnits, Random rand, int ffInputLength, int spatialMapSize, int temporalMapSize, int markovOrder, boolean firstIsSpatial) {
